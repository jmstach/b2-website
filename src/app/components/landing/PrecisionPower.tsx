        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
             ...
             <div className="relative z-10">
                ...
                <p className="text-sm text-white/50">All the functions you use all the time. Smart autocomplete tailored for speed.</p>
             </div>
          </motion.div>
          ...
          >
             ...
             <div className="relative z-10">
                ...
                <p className="text-sm text-white/50">Opinionated typesetting with support for advanced OpenType features.</p>
             </div>
          </motion.div>
